...
function TestUI()
{
	...
	this.shezhi.on(Event.CLICK, this, onshezhiClick);
	this.jia.on(Event.CLICK, this, onjiaClick);
	this.jian.on(Event.CLICK, this, onjianClick);
	this.turn3.on(Event.CLICK, this, onturn3Click);
	...
	function onshezhiClick(){
		...
		this.turn3.visible = true;
		this.jia.visible = true;
		this.jian.visible = true;
		this.label1.visible = true;
	}

	function onturn3Click(){
		this.titile1.visible = true;
		this.titile2.visible = true;
		this.titile3.visible = true;
		this.titile4.visible = true;
	...
	function onjiaClick(){
		this.label1.text = "出现2的概率：" + ( * 10) + "%";
	}

	function onjianClick(){
...
function beginLoad(){
	...
	Laya.loader.load("res/music.wav", Handler.create(null, onmusic));
}
...
function onmusic(){
	Laya.SoundManager.playMusic( "res/music.wav", 0 );
}